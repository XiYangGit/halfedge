...
public:
    ...
    int unifJointTransformations;
    int attrInfluencerID;
    int attrWeights;
...
public:
    ...
    void setUnifTime(int t);
    void SetUnifRenderMode(int i);

    QString qTextFileRead(const char*);
    //added by Xi Yang
    void SetUnifBindMatrices(const glm::mat4 (&i)[100]);
    void SetUnifJointTransformations(const glm::mat4 (&i)[100]);
private:
